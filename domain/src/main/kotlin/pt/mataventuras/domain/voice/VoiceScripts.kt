...
object VoiceScripts {
    ...
    const val INVADERS_HINT: String =
        "Tens 5 vidas. Destrói todas as naves. Desliza para mover e toca para disparar."
    const val CHOMP_HINT: String =
        "Tens 3 vidas. Desliza para comer as bolinhas. A pílula dourada transforma-te!"
    const val CLIMB_HINT: String =
        "Tens 3 vidas. Anda e salta para subir as letras. Evita os barris. O cogumelo faz-te crescer!"
    ...
    const val AGE_SEVEN_PREVIEW: String =
        "Somar, subtrair, multiplicar, dividir e lógica. " +
            "Jogos do sapo, das filas e das cruzes. Prémio: corrida, invasores ou labirinto!"
