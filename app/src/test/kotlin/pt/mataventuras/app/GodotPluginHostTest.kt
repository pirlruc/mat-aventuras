...
class GodotPluginHostTest {
    ...
    fun godotProjectIsPackagedWithCompatibilityRenderer() {
        ...
        assertTrue(bootScene.contains("ColorRect"))
        ...
        assertTrue(boot.contains("_process"))
        assertTrue(boot.contains("_sized_frames"))
        assertFalse(boot.contains("call_deferred("))
        assertFalse(boot.contains("await "))
        assertFalse(boot.contains("force_draw"))
        assertTrue(boot.contains("change_scene_to_packed"))
        assertTrue(boot.contains("get_script()"))
        assertTrue(boot.contains("Host.finish"))
        assertTrue(boot.contains("Host.finish(false, false)"))
        ...
        assertTrue(runnerScript.contains("Host.is_jump_flick"))
        ...
        assertTrue(invadersScript.contains("Letras") || invadersScript.contains("Vidas"))
        ...
        assertTrue(chompScript.contains("var pos: Vector2 = sample.pos"))
        assertFalse(chompScript.contains("var nx := sample.pos"))
        ...
        assertTrue(hostScript.contains("skin_hud"))
        assertTrue(hostScript.contains("linger"))
        assertTrue(hostScript.contains("create_timer"))
        assertTrue(hostScript.contains("_complete"))
        assertFalse(hostScript.contains("await "))
        assertTrue(hostScript.contains("DEADZONE"))
        assertTrue(hostScript.contains("JUMP_FLICK"))
        assertTrue(hostScript.contains("read_pointer"))
